...
class CustomHelpCommand(commands.HelpCommand):
        ...
        for cog, commands in mapping.items():
            if cog is not None:
                ...
                if filtered:
                    ...
                    embed.set_footer(text=f"Use {get_prefix}help [cog] or {get_prefix}help [command] for more info.")
    ...
    async def send_cog_help(self, cog):
        ...
        embed.set_footer(text=f"Use {get_prefix}help [command] for more info on a command.")
        await self.get_destination().send(embed=embed)
