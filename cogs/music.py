...
class Music(commands.Cog):
    ...
    # summon music bot to voice channel
    ...
    # displays the songs playlist if there is more than 1 song input
    ...
    async def _musichelp(self, ctx):
        ...
        embed.add_field (
            name="summon",
            value="Summons the bot to a voice channel",
            inline=False
        )
        embed.add_field (
            name="join",
            value="Make the bot join a voice channel",
            inline=False
        )
        embed.add_field (
            name="leave / disconnect / dc",
            value="Disconnects the bot from a voice channel",
            inline=False
        )
        embed.add_field (
            name="play",
            value="Play a song using a Yotube URL or type in the song name and artist name",
            inline=False
        )
        embed.add_field (
            name="stop",
        ...
        embed.add_field (
            name="shuffle",
            value="Shuffle the songs in the queue",
            inline=False
        )
        embed.add_field (
            name="pause",
        ...
        embed.add_field (
            name="volume",
            value="Adjust the music player volume (max volume is 100)\nYou can also manually adjust the bot's volume level beyond 100",
            inline=False
        )
        await ctx.send(embed=embed)
