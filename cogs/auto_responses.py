        ...
        if message.content.lower().startswith("hey endroid"):
            ...
            # how are you
                ...
                if reply_message.content.lower().startswith("how are you"):
                    await reply_message.channel.trigger_typing()
                    await reply_message.channel.send("I'm okay, thank you.")
                ...
                if reply_message.content.lower().startswith("tell me about robot laws") or reply_message.content.lower().startswith("tell me about the robot laws") or reply_message.content.lower().replace("'", "").strip().startswith("tell me about isaac asimovs robot laws"):
                    embed = discord.Embed (
